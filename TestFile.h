namespace strata{
	bool mutton(int sheep);
	int beef(string Claf);
	Aclass function(arg1 an,Yarg2 man);
	Bclass functoin(arg1 magger,
		arg2 sagger);
	stuuuuuuuuuuuuuuuuuuuuuuuupid
		fuctiooooiin(minger mmi, bannasn hithead);
	studppppppppppppppppiiiiiiiiiiiiiiiiiidf
	...
	float Log(StaticFunctionTag* base, float arg1);	UInt32 LeftShift(StaticFunctionTag* base, UInt32 value, UInt32 shiftBy);
	UInt32 RightShift(StaticFunctionTag* base, UInt32 value, UInt32 shiftBy);
	UInt32 LogicalAnd(StaticFunctionTag* base, UInt32 arg1, UInt32 arg2);
	UInt32 LogicalOr(StaticFunctionTag* base, UInt32 arg1, UInt32 arg2);
	UInt32 LogicalXor(StaticFunctionTag* base, UInt32 arg1, UInt32 arg2);
